const NextJSBlob = () => {
  return (
    <div>
      <div
        className=" flex place-items-center before:absolute z-10 fixed top-6
   
      
       after:absolute after:z-20 after:h-[180px] after:w-[240px] 
      after:translate-x-1/3 after:hidden after:dark:block after:bg-gradient-to-br after:from-sky-300 after:via-cyan-400 
      after:blur-xl after:content-['']after:dark:from-fuchsia-400
...
const SaqGreenBlob = () => {
  return (
    <div className=" ">
      <div
        className=" flex place-items-center before:absolute z-10 fixed bottom-60   right-60
      before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full  before:hidden before:lg:block 
      ...
      after:translate-x-1/3 after:bg-gradient-to-t
